...
export default function UserGuidePage({ title, description, panels }: Props) {
  ...
  return (
    <div>
      ...
      <Accordion panels={finalPanels} defaultOpenPanels={[0]} />
...
export const getStaticProps: GetStaticProps = async () => {
  const changelogPath = path.join(process.cwd(), 'USERGUIDE.md');
