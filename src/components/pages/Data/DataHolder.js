    ...
    return (
      <div className="data-container">
        ...
        <DataButton
          ...
          sendData={() =>
            this.setState({ dataChanged: false }, sendData(vocabulary, expressions))
          }
          {...this.state}
        />
        ...
        <Accordion fluid>
          ...
          <Accordion.Content active={activeIndex === 0}>
            <DataAccordion data={vocabulary} {...this} {...this.props} {...this.state} />
          </Accordion.Content>
          ...
          <Accordion.Content active={activeIndex === 1}>
            <DataAccordion data={expressions} {...this} {...this.props} {...this.state} />
          </Accordion.Content>
        </Accordion>
      </div>
    );
