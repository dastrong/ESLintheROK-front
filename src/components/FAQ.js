...
const panels = [
    ...
    content: {
      ...
      content: (
        <p>
          ...
          {
            <Link to={{ pathname: "/about", state: { pageTransition: "slideUp" } }}>
              here
            </Link>
          }
          .
      ...
      content: (
        <div>
          <p>
            Head to our{" "}
            {
              <Link to={{ pathname: "/contact", state: { pageTransition: "slideUp" } }}>
                contact
              </Link>
            }{" "}
            page.
    ...
    content: {
      ...
      content: (
        <div>
          ...
          <p>
            Although any teacher can enter custom data and modify the rules for their
            classes.
          </p>
        </div>
      ),
  ...
  },
  {
    ...
    content: {
      ...
      content: <p>Unlike other websites, this one is completely free to use.</p>,
    },
  },
  {
